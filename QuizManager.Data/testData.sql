SET IDENTITY_INSERT QuizManagerTest.dbo.AspNetUsers ON;
INSERT INTO QuizManagerTest.dbo.AspNetUsers (Id, Email, EmailConfirmed, PasswordHash, SecurityStamp, PhoneNumber,
...
VALUES (N'1ab1cf34-da50-4b1b-9c25-b292b909bcb6', N'anotheruser3@test.com', 0,
        ...
        N'71bf51f4-fddb-4287-a91c-635d6e9295ff', null, 0, 0, null, 1, 0, N'Mary');
INSERT INTO QuizManagerTest.dbo.AspNetUsers (Id, Email, EmailConfirmed, PasswordHash, SecurityStamp, PhoneNumber,
                                             PhoneNumberConfirmed, TwoFactorEnabled, LockoutEndDateUtc, LockoutEnabled,
                                             AccessFailedCount, UserName)
VALUES (N'6d49ac46-be22-476b-9055-ac649039348e', N'user@test.com', 0,
        ...
        N'03c58ff2-2612-4d7a-8c47-f609e7dca2f5', null, 0, 0, null, 1, 0, N'Terry');
INSERT INTO QuizManagerTest.dbo.AspNetUsers (Id, Email, EmailConfirmed, PasswordHash, SecurityStamp, PhoneNumber,
                                             PhoneNumberConfirmed, TwoFactorEnabled, LockoutEndDateUtc, LockoutEnabled,
                                             AccessFailedCount, UserName)
VALUES (N'b3887680-9278-436a-86eb-2d224e944658', N'user4@test.com', 0,
        ...
        N'a58ad6c3-aa3d-4254-81c7-2660419024e4', null, 0, 0, null, 1, 0, N'Anthony');
INSERT INTO QuizManagerTest.dbo.AspNetUsers (Id, Email, EmailConfirmed, PasswordHash, SecurityStamp, PhoneNumber,
                                             PhoneNumberConfirmed, TwoFactorEnabled, LockoutEndDateUtc, LockoutEnabled,
                                             AccessFailedCount, UserName)
VALUES (N'b3b50224-1c60-4fb7-8adc-e6457f1a8185', N'anotheruser@test.com', 0,
        ...
        N'd3b1e4bd-b267-437f-a387-5b4f6e42c2be', null, 0, 0, null, 1, 0, N'James');
INSERT INTO QuizManagerTest.dbo.AspNetUsers (Id, Email, EmailConfirmed, PasswordHash, SecurityStamp, PhoneNumber,
                                             PhoneNumberConfirmed, TwoFactorEnabled, LockoutEndDateUtc, LockoutEnabled,
                                             AccessFailedCount, UserName)
VALUES (N'd3b94c0a-4c50-4d3c-ab57-00aba31da471', N'user2@test.com', 0,
        ...
        N'23b22a6c-72f0-45e0-a241-53b0b3111dda', null, 0, 0, null, 1, 0, N'Jimmy');
SET IDENTITY_INSERT QuizManagerTest.dbo.AspNetUsers OFF;

SET IDENTITY_INSERT QuizManagerTest.dbo.quiz ON;
...
SET IDENTITY_INSERT QuizManagerTest.dbo.quiz OFF;

SET IDENTITY_INSERT QuizManagerTest.dbo.question ON;
...
INSERT INTO QuizManagerTest.dbo.question (id, quizId, round, questionNumber)
VALUES (15, 2, 1, 5);
SET IDENTITY_INSERT QuizManagerTest.dbo.question OFF;

SET IDENTITY_INSERT QuizManagerTest.dbo.AspNetUsers_quiz ON;
...
SET IDENTITY_INSERT QuizManagerTest.dbo.AspNetUsers_quiz OFF;

INSERT INTO QuizManagerTest.dbo.gameState (quizId, questionId)
VALUES (1, 3);
INSERT INTO QuizManagerTest.dbo.gameState (quizId, questionId)
VALUES (2, 11);
